...
AR = ar
objs = Graph.o GraphVis.o CentralityMeasures.o PQ.o Dijkstra.o testLanceWilliamsHAC.o
...
testLanceWilliamsHAC : testLanceWilliamsHAC.c LanceWilliamsHAC.c GraphLib.a
	$(CC) -o testLanceWilliamsHAC testLanceWilliamsHAC.c LanceWilliamsHAC.c GraphLib.a  -lm
