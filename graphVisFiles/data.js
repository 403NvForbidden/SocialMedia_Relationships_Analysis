g = {
  nodes: [
    {id:'0',label:'0',x:0.300000,y:0.000000, size:0.2, color: getColor(0.000000,gradient)},
    {id:'1',label:'1',x:0.150000,y:0.259808, size:0.2, color: getColor(0.000000,gradient)},
    {id:'2',label:'2',x:-0.150000,y:0.259808, size:0.2, color: getColor(0.600000,gradient)},
    ...
    {id:'5',label:'5',x:0.150000,y:-0.259808, size:0.2, color: getColor(0.200000,gradient)}
  ],
  edges: [
    ...
    {source:'3',target:'5',id:'5',label:'1',type: 'curvedArrow'},
